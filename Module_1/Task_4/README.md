...
Ссылка на весь fork со всеми изменениями [shvirtd-example-python](https://github.com/Legend1Demp8/shvirtd-example-python/tree/main)
...
### UPD2 включил log в файл и debug ничего не пишет
### UPD3 захватил процесс strace ошибок нет
### UPD4 наверно хватит ковыряться в том что написано и забыто
### UPD5 Дал последний шанс взял форк у которого даже версия выше вместо 0.13.1 целая 0.14.0 Но все равно не работает (https://github.com/joschi/dive)
